...
{
	//1.1.0 to 1.1.1
	$query[] = "UPDATE `" . $DBPrefix . "settings` SET `version` = '1.1.2';";
}

if ($myversion == '1.1.2')
{
	//1.1.0 to 1.1.1
	$query[] = "UPDATE `" . $DBPrefix . "settings` SET `version` = '1.1.2P1';";
}

if ($myversion == '1.1.2P1')
{
	//1.1.0 to 1.1.1
	$query[] = "UPDATE `" . $DBPrefix . "settings` SET `version` = '1.1.2P2';";
}
?>