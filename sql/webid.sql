...
(1, 'admin', 'c57563fab5c0aa427a476c463bb87d47', 'zka80', '20150727', '1437991628', 1, NULL);
...
INSERT INTO `webid_auctions` (`id`, `user`, `title`, `subtitle`, `starts`, `description`, `pict_url`, `category`, `secondcat`, `minimum_bid`, `shipping_cost`, `shipping_cost_additional`, `reserve_price`, `buy_now`, `auction_type`, `duration`, `increment`, `shipping`, `payment`, `international`, `ends`, `current_bid`, `closed`, `photo_uploaded`, `quantity`, `suspended`, `relist`, `relisted`, `num_bids`, `sold`, `shipping_terms`, `bn_only`, `bold`, `highlighted`, `featured`, `current_fee`, `tax`, `taxinc`) VALUES
(1, 2, 'Sanga&#39;s Cap', '2x6&quot; space', '1437991027', '<p>\r\n	blah blah</p>\r\n', '', 171, 0, 0.99, 0.00, 0.00, 0.00, 0.00, '1', '1', 0.00, '3', '0', '0', '1438077427', 4.50, 0, 0, 1, 0, 0, 0, 10, 'n', '', 'n', 'n', 'n', 'n', 0.00, 'n', 'y'),
(2, 3, 'Sanga&#39;s Bat', 'b;ljlkhkh', '1437994808', '<p>\r\n	hjjhghj</p>\r\n', '', 173, 0, 6.00, 0.00, 0.00, 0.00, 0.00, '1', '1', 0.00, '3', '1', '0', '1438081208', 0.00, 0, 0, 1, 0, 0, 0, 0, 'n', '', 'n', 'n', 'n', 'n', 0.00, 'n', 'y');
...
(1, 1, 3, 0.99, '1437991688', 1),
(2, 1, 1, 1.28, '1437991965', 1),
(3, 1, 3, 1.78, '1437991965', 1),
(4, 1, 3, 2.00, '1437991991', 1),
(5, 1, 1, 2.50, '1437991991', 1),
(6, 1, 1, 2.56, '1437992085', 1),
(7, 1, 3, 3.06, '1437992085', 1),
(8, 1, 1, 4.00, '1437992274', 1),
(9, 1, 3, 4.00, '1437992274', 1),
(10, 1, 1, 4.50, '1437992295', 1);
...
(170, 1, 50, 57, 0, 'Sports &amp; Recreation', 2, 0, '', ''),
(171, 170, 55, 56, 1, 'Apparel &amp; Equipment', 1, 0, '', ''),
(172, 170, 53, 54, 1, 'Exercise Equipment', 0, 0, '', ''),
(173, 170, 51, 52, 1, 'General', 1, 0, '', ''),
...
CREATE TABLE IF NOT EXISTS `webid_gateways` (
  `gateways` text,
...
(1, 'user', 'Regestered User', 0, 1, '::1', 1437989843),
(2, 'user', 'Regestered User', 0, 2, '172.22.178.27', 1437990869),
(3, 'user', 'List Item', 1, 2, '172.22.178.27', 1437991027),
(4, 'user', 'Regestered User', 0, 3, '172.22.178.27', 1437991546),
(5, 'user', 'Bid on Item', 1, 3, '172.22.178.27', 1437991688),
(6, 'user', 'Bid on Item', 1, 3, '172.22.178.27', 1437991756),
(7, 'user', 'Bid on Item', 1, 3, '172.22.178.27', 1437991788),
(8, 'user', 'Bid on Item', 1, 3, '172.22.178.27', 1437991864),
(9, 'user', 'Bid on Item', 1, 1, 'fe80::e86b:b4d0:ce1c:9346', 1437991966),
(10, 'user', 'Bid on Item', 1, 1, 'fe80::e86b:b4d0:ce1c:9346', 1437991992),
(11, 'user', 'Bid on Item', 1, 3, '172.22.178.27', 1437992086),
(12, 'user', 'Bid on Item', 1, 1, 'fe80::e86b:b4d0:ce1c:9346', 1437992274),
(13, 'user', 'Bid on Item', 1, 1, 'fe80::e86b:b4d0:ce1c:9346', 1437992296),
(14, 'user', 'List Item', 2, 3, '172.22.178.27', 1437994808);
...
INSERT INTO `webid_proxybid` (`itemid`, `userid`, `bid`) VALUES
(1, 3, 2.00),
(1, 1, 2.56),
(1, 3, 4.00),
(1, 1, 1200.00);
...
(1, 'ramdesh', '2354a4e29970ceb65de2c6ae89980def', 'u69ni', 'Ramindu', '181, Colombo Road, Divulpitiya, Boralesgamuwa', 'Colombo', 'Western', 'United Kingdom', '10290', '094719439733', 'rasade88@gmail.com', 1437989843, 0, 0, 19880717, 0, 1, 0.00, NULL, NULL, 'one', 'yes', 'html', '2015-07-27 10:12:22', NULL, '1,2', 'y', 6, '', '', '', '', '', '', 'EN'),
(2, 'pwelagedara', 'e47ee91bd1124b939b5b3bbdf0c03095', 'k8efy', 'Pubudu', '406/33', 'Colombo', 'Colombo', 'United Kingdom', '10200', '94774989599', 'pwelagedara@gmail.com', 1437990869, 0, 0, 19880416, 0, 2, 0.00, NULL, NULL, 'one', 'yes', 'html', '2015-07-27 10:02:19', NULL, '1,2', 'y', 0, '', '', '', '', '', '', 'EN'),
(3, 'rwelagedara', '5dca2f218e19810166ceae73bac77f15', 'cl8oj', 'Rasika', '406/33', 'Colombo', 'Colombo', 'United Kingdom', '10200', '94774989599', 'rwelagedara@virtusa.com', 1437991546, 0, 0, 19880416, 0, 1, 0.00, NULL, NULL, 'one', 'yes', 'html', '2015-07-27 10:07:54', NULL, '1,2', 'y', 0, '', '', '', '', '', '', 'EN');
...
(1, 1, '::1', 'first', 'accept'),
(2, 2, '172.22.178.27', 'first', 'accept'),
(3, 3, '172.22.178.27', 'first', 'accept'),
(4, 1, 'fe80::e86b:b4d0', 'after', 'accept');
