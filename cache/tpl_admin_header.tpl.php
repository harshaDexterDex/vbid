...
<head>
	...
	<script type="text/javascript" src="<?php echo (isset($this->_rootref['SITEURL'])) ? $this->_rootref['SITEURL'] : ''; ?>loader.php?<?php echo (isset($this->_rootref['EXTRAJS'])) ? $this->_rootref['EXTRAJS'] : ''; ?>"></script>
