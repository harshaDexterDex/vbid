...
$(function() {
	...
	$("#uploader").pluploadQueue({
		...
		filters : {
		    // Maximum file size
			max_file_size : "<?php echo (isset($this->_rootref['MAXPICSIZE_MB'])) ? $this->_rootref['MAXPICSIZE_MB'] : ''; ?>mb",
			// Specify what files to browse for
			mime_types: [
...
$(document).ready(function () {
	...
	if ( <?php echo (isset($this->_rootref['MAXPICS'])) ? $this->_rootref['MAXPICS'] : ''; ?> == <?php echo (isset($this->_rootref['UPLOADED'])) ? $this->_rootref['UPLOADED'] : ''; ?>) {$('.plupload_file_name').hide('slow'); $('.moxie-shim-html5').hide();}
