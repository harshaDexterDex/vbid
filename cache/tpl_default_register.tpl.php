	...
	<?php } ?>
        ...
        <?php } if ($this->_rootref['PROV']) {  ?>
					<tr>
						...
						<td width="60%">
							<input type="text" name="TPL_prov" size="25" maxlength="25" value="<?php echo (isset($this->_rootref['V_PROV'])) ? $this->_rootref['V_PROV'] : ''; ?>" <?php if ($this->_rootref['MISSING8'] == (1)) {  ?>class="missing"<?php } ?>>
