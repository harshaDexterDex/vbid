                        ...
                        <tr>
                            ...
                            <td>
                            	<input type="radio" name="status" value="1"<?php if ($this->_rootref['B_ACTIVE']) {  ?> checked="checked"<?php } ?>> <?php echo ((isset($this->_rootref['L_566'])) ? $this->_rootref['L_566'] : ((isset($MSG['566'])) ? $MSG['566'] : '{ L_566 }')); ?><br>
                  				<input type="radio" name="status" value="2"<?php if ($this->_rootref['B_INACTIVE']) {  ?> checked="checked"<?php } ?>> <?php echo ((isset($this->_rootref['L_567'])) ? $this->_rootref['L_567'] : ((isset($MSG['567'])) ? $MSG['567'] : '{ L_567 }')); ?>
                            </td>
                        </tr>
                    </table>
